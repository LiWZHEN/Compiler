...
enum NodeType {
  ...
  type_function_param, type_shorthand_self, type_type, type_pattern, type_wildcard_pattern,
  type_reference_pattern, type_identifier_pattern, type_literal_pattern, type_path_in_expression,
  type_literal_expression, type_path_expr_segment, type_reference_type, type_array_type,
  type_type_path, type_unit_type, type_expression, type_statements, type_statement, type_let_statement,
  type_expression_statement, type_struct_expr_fields, type_struct_expr_field, type_char_literal,
  type_string_literal, type_raw_string_literal, type_c_string_literal, type_raw_c_string_literal,
  type_integer_literal, type_struct_fields, type_struct_field, type_enum_variants, type_associated_item
};
